...
const backupConfig = require('../config.js')

let useSQL = true; // DO NOT CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE DOING
let con;

class HDClient extends Discord.Client {
    constructor(options = {}) {
        super(options);
        ...
        this.themeColor = backupConfig.colorhex
        this.aboutServer = backupConfig.aboutServer
